...
// isolate a rollout-percentage-only change); the value type itself lives here so it can travel on
// SnapshotUpdate alongside the rest of this package's wire vocabulary.
